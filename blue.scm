...
;; blue.scm
;;
;; own datatype completely inpenetrable
;; 
;;

(define error (lambda (x) (write "HALT ")(write x)))
...
(define (shared-arg-passing op args env cont)
  ...
  (let* ((mlam (cadr op))
	 (mlam-arg (cadr mlam))
	 (mlam-body (cddr mlam)))
    (eam-case123 mlam-arg args mlam-body env cont)))
